      ...
      <div className="container">
        <div className="left">
          <div className="wrapper">
            ...
            <select
              name=""
              id="state"
              onChange={(e) => {setState(e.target.value);setCityName(0);setLandmark(0)}}
              className="select"
            >
              {states.map((e, ind) => {
                return (
                  <option value={ind} key={e.name} className="option">
                    {e.name}
                  </option>
                );
              })}
          ...
          <div className="wrapper">
            ...
            <select
              name=""
              id="city"
              onChange={(e) => {setCityName(e.target.value);setLandmark(0)}}
              className="select"
            >
              {states[state].city.map((data, ind) => {
                return (
                  <option key={data.name} value={ind} className="option">
                    {data.name}
                  </option>
                );
              })}
          ...
          <div className="wrapper">
            ...
            <select
              ...
              className="select"
            >
              {states[state].city[cityName].landmarks.map((data, ind) => {
                return (
                  <option value={ind} key={data.name} className="option">
                    {data.name}
                  </option>
                );
              })}
        ...
        <div className="right">
          <div id="state-name" className="box">
            <div id="state-title" className="title">
              {states[state].name}
            </div>
            <div id="state-description" className="desc">
              {states[state].description}
            </div>
          </div>

          <div id="city-name" className="box">
            <div id="city-title" className="title">
              {states[state].city[cityName].name}
            </div>
            <div id="city-description" className="desc">
             {
				states[state].city[cityName].description
			 }
            </div>
          </div>
          <div id="landmark-name" className="box">
            <div id="landmark-title" className="title">
			{states[state].city[cityName].landmarks[landmark].name}
            </div>
            <div id="landmark-description" className="desc">
			{states[state].city[cityName].landmarks[landmark].description}
            </div>
          </div>
        </div>
      </div>
